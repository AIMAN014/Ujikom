    ...
    <div class="row justify-content-center align-items-center vh-100"">
        <div class="col-5">
            ...
            <?php 
                ...
                if($submit=='Upload'){
                    ...
                    if(move_uploaded_file($tmp_foto, 'uploads/'.$lokasi_file)) {
                        $insert=mysqli_query($conn, "INSERT INTO foto VALUES('', '$judul_foto', '$deskripsi_foto', '$tanggal', '$lokasi_file', '$user_id')");
                ...
                $val=mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM foto WHERE foto_id='$fotoid'"));
            ?> 
            <?php if(!isset($_GET['edit']) && !isset($_GET['hapus'])): ?>
            <form action="?url=upload" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Judul Foto</label>
                    <input type="text" class="form-control" name="judul_foto" require>
                </div>
                <div class="form-group">
                    <label>Deskripsi Foto</label>
                    <textarea name="deskripsi_foto" class="form-control" cols="30" rows="5" require></textarea>
                </div>
                <div class="form-group">
                    <label>Pilih Gambar</label>
                    <input type="file" name="lokasi_file" class="form-control" require accept=".jpg .png .gif">
            ...
            <?php elseif(isset($_GET['edit'])): ?>
                ...
                <div class="form-group">
                    <label>Judul Foto</label>
                    <input type="text" class="form-control" value="<?= $val['judul_foto'] ?>" name="judul_foto" require>
                </div>
                <div class="form-group">
                    <label>Deskripsi Foto</label>
                    <textarea name="deskripsi_foto" class="form-control" cols="30" rows="5" require><?= $val['deskripsi_foto'] ?></textarea>
                </div>
                <div class="form-group">
                    <label>Pilih Gambar</label>
                    <input type="file" name="lokasi_file" class="form-control" require accept=".jpg .png .gif">
